...
function HandlePlayerInput()
{
    ...
    if (Input.GetKey(KeyCode.O)) {
    	desiredDistance = Mathf.Clamp(Distance + 0.5 * MouseWheelSensitivity, DistanceMin, DistanceMax);
    }
    ...
    if (Input.GetKey(KeyCode.LeftArrow)) {
    	mouseX += 0.5f * MouseWheelSensitivity;
    }
    if (Input.GetKey(KeyCode.RightArrow)) {
    	mouseX -= 0.5f * MouseWheelSensitivity;
    }
    if (Input.GetKey(KeyCode.UpArrow)) {
    	mouseY += 0.25f * MouseWheelSensitivity;
    }
