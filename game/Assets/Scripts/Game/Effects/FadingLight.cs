...
public class FadingLight : MonoBehaviour {
	private float fadeSpeed = 1.5f;			// How fast the light fades between intensities.
	private float highIntensity = 1.5f;		// The maximum intensity of the light whilst the alarm is on.
	private float lowIntensity = 0.1f;	   // The minimum intensity of the light whilst the alarm is on.
